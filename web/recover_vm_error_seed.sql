...
begin
    if not exists (select 1 from scenarios where title = 'Recuperar VM presa em ERROR') then
        ...
        insert into scenario_steps (scenario_id, position, command, note) values
            ...
            (new_id, 6, 'openstack server rebuild "meu-servidor"',
